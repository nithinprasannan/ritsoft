...
<div class="newbtn"><a href="dashboard_pgdean.php?menu=view_batch">VIEW ALL BATCHES</a></div>
<?php
...
?></select>
    ...
    <center><input type="submit" value="Add Batch"><input type="reset" name="" id="" value="Cancel"/></center></form>
...
$count=0;
   ...
   $retval = mysqli_query($conn ,$sql);
	...
	{
	   echo "<center><br><br>*********BATCH ALREADY EXIST TRY ANOTHER************<br><br><br></center>";
