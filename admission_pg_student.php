...
if (isset($_REQUEST['button']))
{
   ...
   $obj=new dboperation();
   $q="UPDATE temp SET cur_sem = '$csem', roll_no = '$rlno', rank = '$rnk', quota = '$qta', school_1 = '$scl1', reg_no_yr_1 = '$rgno1', board_1 = '$brd1', school_2 = '$scl2', reg_no_yr_2 = '$rgno2', board_2 = '$brd2', no_chance = '$chnc', name_last = '$nalast', total = '$tot', gate_score = '$score' WHERE temp_no = '$tp_no' ";
    $obj->Ex_query($q);
   $_SESSION['acc']=$tp_no;
...
/* $obj3=new dboperation();
	...
	?>
         ...
         <?php
			...
			if($co == 'MCA')
  			{ ?>
		       <td><label for="score">Gate score</label></td>
        <td><input type="text" name="score" id="score" disabled /></td></tr>
 		   <?php
		    }
            else
            { ?>
	          ...
	          <td><label for="score">Gate score</label></td>
        		<td><input type="text" name="score" id="score"  value="" /></td></tr>
           <?php
		    }
        ...
        <td><input type="text" name="roll_num" id="roll_num"  value="" /></td>
        <td><label for="rank_no">Entrance rank No:</label></td>
        <td><input type="text" name="rank_no" id="rank_no"  value="" /></td></tr>
        <tr>
      ...
      <tr>
        ...
        <td>
          <input type="text" name="school_1" id="school_1"  value="" /></td>
      
        <td><label for="reg_no_yr_1"> Register No & year of passing</label></td>
        <td>
          <input type="text" name="reg_no_yr_1" id="reg_no_yr_1"  value=""  /></td></tr>
           <tr>
